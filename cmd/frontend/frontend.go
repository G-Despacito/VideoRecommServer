...
func main() {
	...
	if len(videos) != 5 || videos[0].VideoId != 1012 || videos[1].Author != "Harry Boehm" ||
		videos[2].VideoId != 1209 || videos[3].Url != "https://video-data.localhost/blob/1309" || videos[4].Title != "precious here" {
	...
	videos = sendSingleTestRequest(userId, videoRecServiceClient)
	if len(videos) != 5 || videos[0].VideoId != 1196 || videos[1].Author != "Rocky Okuneva" ||
		videos[2].VideoId != 1071 || videos[3].Url != "https://video-data.localhost/blob/1041" || videos[4].Title != "witty downstairs" {
